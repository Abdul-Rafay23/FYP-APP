    ...
    <>
      ...
      <div className='w-full h-screen bg-gray-800 flex justify-center items-center'>
        <form className="bg-gray-900 p-8 rounded-lg shadow-lg w-full max-w-lg sm:max-w-xl">
          <h1 className="text-3xl font-semibold text-center text-amber-50 mb-6">Short Questions</h1>
         ...
         <option value="" disabled>Select Difficulty</option>
            ...
            <div className=' mb-2 flex justify-center '>
                <textarea className=' p-4 border-2 border-amber-400 bg-gray-400 text-amber-50 hover:bg-gray-600 w-screen h-36 rounded-2xl'
                type='text'
