...
const StudentQuiz = () => {
  ...
  return (
    <>
      ...
      <div className="w-screen h-screen bg-gray-800 flex justify-center items-center p-2">
        <form className="bg-gray-900 p-8 rounded-lg shadow-lg w-full max-w-lg">
          <h1 className="text-3xl font-semibold text-center text-amber-50 mb-2">Quiz C++</h1>

          <div className="mb-2 flex justify-center">
            <h1 className="text-2xl font-semibold text-center text-amber-50 mb-2">Total Questions 20</h1>
          </div>

          <div className="mb-2 flex justify-center">
            <h1 className="text-2xl font-semibold text-center text-amber-50 mb-2">1/20</h1>
          </div>
          ...
          <div className="mb-2 h-20 w-full rounded-2xl border-8 border-amber-400 bg-amber-400 flex">
            <h1 className="text-2xl font-semibold text-center text-black">Q1. What is C++? </h1>
          </div>

          <div className="mb-2 flex p-4 bg-gray-600 w-full h-48 rounded-2xl">
            <h1 className="text-24 text-amber-50 font-bold">Answer :</h1>
          </div>



          <div className="mb-2 flex justify-center p-4 w-full h-20 rounded-2xl">
            <button
              onClick={() => navigate('/compshuffle')}
              type="submit"
              className="w-full sm:w-1/2 bg-amber-400 text-black font-bold py-3 rounded-4xl hover:bg-amber-600 transition ml-2"
            >
              Submit
            </button>
          </div>
