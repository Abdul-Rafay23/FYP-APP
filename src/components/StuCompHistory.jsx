    ...
    <>
      ...
      <div className='w-full h-screen bg-gray-800 flex justify-center items-center px-4'>
        <form className="bg-gray-900 p-8 rounded-lg shadow-lg w-full max-w-lg">
          <h1 className="text-3xl font-semibold text-center text-amber-50 mb-6">Competition History</h1>

          {/* Full Name */}
          <div className="mb-2 w-44 h-12 rounded-3xl ml-34  bg-amber-400 p-0.5 justify-center text-center ">
          ...
          <div className="mb-8 w-full h-32 rounded-2xl  bg-amber-400 p-0.5 justify-center text-center">
            ...
            <div>
                <h1 className=' text-md font-bold'>C# Competition Spring 23</h1>
            </div>
            <div className=' w-48 h-8 rounded-xl bg-black mt-2 ml-32 Flex justify-center text-center '>
                <h1 className=' text-amber-50 text-sm p-1.5 '> 5th Place</h1>
            </div>
          </div>
          ...
          <div className="mb-8 w-full h-32 rounded-2xl  bg-amber-400 p-0.5 justify-center text-center">
            ...
            <div>
                <h1 className=' text-md font-bold'>JAVA Competition Fall 24</h1>
            </div>
            <div className=' w-48 h-8 rounded-xl bg-black mt-2 ml-32 Flex justify-center text-center '>
                <h1 className=' text-amber-50 text-sm p-1.5 '> 2nd Place</h1>
            </div>
          </div>
