    ...
    <>
      ...
      <div className="w-screen h-screen bg-gray-800 flex justify-center items-center p-4">
        <form className="bg-gray-900 p-8 rounded-lg shadow-lg w-full max-w-lg">
          <h1 className="text-3xl font-semibold text-center text-amber-50 mb-6">Quiz</h1>
          ...
          <div className="mb-4 h-20 w-full rounded-2xl border-8 border-amber-400 bg-amber-400 flex">
            ...
            <h2 className="text-xl font-semibold  text-amber-50"></h2>
          </div>

          <div className="mb-2 flex p-2 w-full ">
            <h1 className="text-24 text-amber-50 font-bold">Answer :</h1>
          </div>

          <div className="mb-2   w-full  rounded-2xl">
          <textarea
            id="answer"
             placeholder="Type answer here"
             className="w-full h-24 p-3 bg-gray-800 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-600 text-amber-50 placeholder-gray-400 resize-none"
            />
